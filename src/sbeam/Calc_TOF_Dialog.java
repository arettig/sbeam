...
public class Calc_TOF_Dialog extends JDialog implements ActionListener,
	...
	public Calc_TOF_Dialog(MainFrame p, sbapp app, Calc_data calc) {
		...
		num_tofs = calculation.GetNumTOFs();
		calc_lab_angles = calculation.GetTOFLabAngles();
		calc_polar_angles = calculation.GetTOFPolarAngles();
		calc_depolar = calculation.GetDepolarizations();
		calc_is_polarized = calculation.GetIsPolarized();
		...
		starting_time_edit.setText("" + calculation.GetStartingTime());
		ending_time_edit.setText("" + calculation.GetEndingTime());
		num_tof_points_edit.setText("" + calculation.GetNumTOFPoints());
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource().equals(ok)) {
			...
			calculation.SetNumTOFs((int) num_tofs_updown.getValue());
	...
	public static void main(String[] args) {
		Calc_TOF_Dialog c = new Calc_TOF_Dialog(null, null, null);
		c.Execute();
	}
